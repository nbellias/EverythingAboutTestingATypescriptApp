...
test_1.test.describe("New Todo", () => {
  (0, test_1.test)("should allow me to add todo items", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
test_1.test.describe("Item", () => {
  (0, test_1.test)("should allow me to mark items as complete", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      // create a new todo locator
      const newTodo = page.getByPlaceholder("What needs to be done?");
      // Create two items.
  ...
  (0, test_1.test)("should allow me to un-mark items as complete", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      // create a new todo locator
      const newTodo = page.getByPlaceholder("What needs to be done?");
      // Create two items.
  ...
  (0, test_1.test)("should allow me to edit an item", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield createDefaultTodos(page);
...
test_1.test.describe("Editing", () => {
  ...
  (0, test_1.test)("should hide other controls when editing", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const todoItem = page.getByTestId("todo-item").nth(1);
      yield todoItem.dblclick();
      yield (0, test_1.expect)(
        todoItem.getByRole("checkbox"),
      ).not.toBeVisible();
      yield (0, test_1.expect)(
  ...
  (0, test_1.test)("should save edits on blur", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const todoItems = page.getByTestId("todo-item");
  ...
  (0, test_1.test)("should trim entered text", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const todoItems = page.getByTestId("todo-item");
      yield todoItems.nth(1).dblclick();
      yield todoItems
  ...
  (0, test_1.test)("should cancel edits on escape", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const todoItems = page.getByTestId("todo-item");
      yield todoItems.nth(1).dblclick();
      yield todoItems
...
test_1.test.describe("Clear completed button", () => {
  ...
  (0, test_1.test)("should display the correct text", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  (0, test_1.test)("should remove completed items when clicked", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const todoItems = page.getByTestId("todo-item");
...
test_1.test.describe("Persistence", () => {
  (0, test_1.test)("should persist its data", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      // create a new todo locator
      const newTodo = page.getByPlaceholder("What needs to be done?");
      for (const item of TODO_ITEMS.slice(0, 2)) {
...
test_1.test.describe("Routing", () => {
  ...
  (0, test_1.test)("should allow me to display active items", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      yield (0, test_1.expect)(todoItem).toHaveText([
        TODO_ITEMS[0],
        TODO_ITEMS[2],
      ]);
    }),
  );
  (0, test_1.test)("should respect the back button", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const todoItem = page.getByTestId("todo-item");
      yield page.getByTestId("todo-item").nth(1).getByRole("checkbox").check();
      yield checkNumberOfCompletedTodosInLocalStorage(page, 1);
      yield test_1.test.step("Showing all items", () =>
        __awaiter(void 0, void 0, void 0, function* () {
          yield page.getByRole("link", { name: "All" }).click();
          yield (0, test_1.expect)(todoItem).toHaveCount(3);
        }),
      );
      yield test_1.test.step("Showing active items", () =>
        __awaiter(void 0, void 0, void 0, function* () {
          yield page.getByRole("link", { name: "Active" }).click();
        }),
      );
      yield test_1.test.step("Showing completed items", () =>
        __awaiter(void 0, void 0, void 0, function* () {
  ...
  (0, test_1.test)("should allow me to display completed items", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield page.getByTestId("todo-item").nth(1).getByRole("checkbox").check();
      yield checkNumberOfCompletedTodosInLocalStorage(page, 1);
      yield page.getByRole("link", { name: "Completed" }).click();
  ...
  (0, test_1.test)("should allow me to display all items", ({ page }) =>
    __awaiter(void 0, void 0, void 0, function* () {
      yield page.getByTestId("todo-item").nth(1).getByRole("checkbox").check();
      yield checkNumberOfCompletedTodosInLocalStorage(page, 1);
      yield page.getByRole("link", { name: "Active" }).click();
